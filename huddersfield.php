      ...
      <div class="tabs">
        ...
        <div class="tab-content active" id="tabs-1">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
               <?php include("php/statshuddersfield.php"); ?>
              </div>
            </div>        
          </div>
        </div>
        <div class="tab-content" id="tabs-2">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
               <?php include("php/schedulehuddersfield.php"); ?>
              </div>
            </div>          
          </div>
        </div>
        <div class="tab-content" id="tabs-3">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
                <p>
                  <?php include("php/playershuddersfield.php"); ?>
                </p>
        ...
        <div class="tab-content" id="tabs-4">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
                <p>
                <?php include("php/managerhuddersfield.php"); ?>
                </p>
                <table class="team_table"></table>
              </div>
            </div>      
