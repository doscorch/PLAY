      ...
      <div class="tabs">
        ...
        <div class="tab-content active" id="tabs-1">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
               <?php include("php/statssouthampton.php"); ?>
              </div>
            </div>        
          </div>
        </div>
        <div class="tab-content" id="tabs-2">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
               <?php include("php/schedulesouthampton.php"); ?>
              </div>
            </div>          
          </div>
        </div>
        <div class="tab-content" id="tabs-3">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
                <p>
                  <?php include("php/playerssouthampton.php"); ?>
                </p>
        ...
        <div class="tab-content" id="tabs-4">
          <div class="business-card">
            ...
            <div class="business-card-body">
              <div>
                <p>
                <?php include("php/managersouthampton.php"); ?>
                </p>
                <table class="team_table"></table>
              </div>
            </div>      
